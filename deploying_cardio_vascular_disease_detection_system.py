# -*- coding: utf-8 -*-
"""Deploying Cardio Vascular disease detection system.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Pqr_tohY7Rk_FabeKVnFDCW18c7YM99-
...
with open('xgboost_trained_model.sav', 'wb') as file:
...
loaded_model = pickle.load(open('xgboost_trained_model.sav', 'rb'))

input_data = ( 25 , 1 , 172 , 90 , 170 , 130 , 1 , 1 , 1 , 1 , 0)

# Get user input to make predictions
user_input = {
    'age': int(input_data[0]),
    'gender': int(input_data[1]),
    'height': float(input_data[2]),
    'weight': float(input_data[3]),
    'ap_hi': int(input_data[4]),
    'ap_lo': int(input_data[5]),
    'cholesterol': int(input_data[6]),
    'gluc': int(input_data[7]),
    'smoke': int(input_data[8]),
    'alco': int(input_data[9]),
    'active': int(input_data[10]),
}
print()
